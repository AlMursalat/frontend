...
const API_BASE = `${BASE_URL}/api/wisata`;
...
function ManagementWisata() {
  ...
  return (
    <div className="space-y-8">
      <h2 className="text-2xl font-bold text-[#526E48]">Manajemen Wisata</h2>
      ...
      >
        <div>
          <label className="block font-medium">Nama Wisata</label>
          <input
            type="text"
            value={nama}
        ...
        <div>
          <label className="block font-medium">Deskripsi (Indonesia)</label>
          <textarea
            value={deskripsi}
        ...
        <div>
          <label className="block font-medium">Deskripsi (English)</label>
          <textarea
            value={deskripsiEn}
            ...
            {data.map((item, index) => (
              <tr key={item.id} className="text-center">
                ...
                <td className="border px-2 py-1 text-left align-top max-w-xs">
                  <div
                    className="h-24 overflow-y-auto text-sm text-gray-700 pr-2"
...
export default ManagementWisata;

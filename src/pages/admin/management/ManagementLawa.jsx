...
const API_BASE = `${BASE_URL}/api/lawa`;
...
function ManagementLawa() {
  ...
  return (
    <div className="space-y-8">
      <h2 className="text-2xl font-bold text-[#526E48]">Manajemen Lawa</h2>
      ...
      >
        <div>
          <label className="block font-medium">Nama Lawa</label>
          <input
            type="text"
            value={nama}
